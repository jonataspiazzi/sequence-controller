...
import './index.scss';
import Svg from '../neonblue/assets/areas.svg';
...
export default function NeonblueIndex() {
  ...
  useEffect(() => {
    ...
    const sTag = rootRef.current.querySelector('#rotate-left') as SVGElement;

    sTag.style.fill = 'rgba(0,0,0,.001)';

    sTag.addEventListener('mouseenter', e => {
      console.log('funcionou');
      sTag.style.fill = '#ff0000';
    });

    sTag.addEventListener('mouseleave', e => {
      console.log('super');
      sTag.style.fill = 'rgba(0,0,0,.01)';
    });
  }, []);
